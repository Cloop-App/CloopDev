...
      },
      include: {
        // schema defines relation fields as `chapter_id_rel` and `subject_id_rel`
        chapter_id_rel: {
          select: {
            title: true
          }
...
        const subjectName = topic.subject_id_rel?.name || 'unknown subject';
        const chapterTitle = topic.chapter_id_rel?.title || 'unknown chapter';
